...
// Source File Name:   MediaTimeSliderModel.java
...
public class MediaTimeSliderModel
    implements BoundedRangeModel, Serializable
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -928772243148993071L;
	public MediaTimeSliderModel()
    {
        changeEvent = null;
    ...
    public MediaTimeSliderModel(int value, int extent, int min, int max)
    {
        changeEvent = null;
        listenerList = new EventListenerList();
        this.value = 0;
    ...
    {
        return (ChangeListener[])listenerList.getListeners(javax.swing.event.ChangeListener.class);
    }
    ...
    {
        String modelString = (new StringBuilder("value=")).append(getValue()).append(", ").append("extent=").append(getExtent()).append(", ").append("min=").append(getMinimum()).append(", ").append("max=").append(getMaximum()).append(", ").append("adj=").append(getValueIsAdjusting()).toString();
        return (new StringBuilder(String.valueOf(getClass().getName()))).append("[").append(modelString).append("]").toString();
    }
