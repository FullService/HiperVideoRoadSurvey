...
// Source File Name:   MediaPlaybackRateSliderModel.java
...
public class MediaPlaybackRateSliderModel implements BoundedRangeModel,
		Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7166963715460669305L;

	public MediaPlaybackRateSliderModel() {
		changeEvent = null;
	...
	public MediaPlaybackRateSliderModel(int value, int extent, int min, int max) {
		changeEvent = null;
		listenerList = new EventListenerList();
		this.value = 1;
		this.extent = 0;
